...
const seoConfig: Record<string, SEOConfig> = {
  ...
  '/services/openclaw-installation': {
    title: 'OpenClaw Installation Service | AI Agent Platform Setup | ₹25,000 | Khosha Systems',
  ...
  '/success-stories': {
    title: 'Customer Success Stories | RetailerOS Results for Indian Retailers | Khosha Systems',
  ...
  '/help': {
    title: 'RetailerOS Knowledge Base & Help Center | Getting Started Guide | Khosha Systems',
