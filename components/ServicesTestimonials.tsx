...
export const ServicesTestimonials: React.FC = () => {
  return (
    <section className="bg-stone-50 py-16 sm:py-20 px-5 sm:px-6 md:px-12 lg:px-24">
        ...
        >
          {testimonials.map((t) => (
            <motion.div
              ...
              className="relative bg-white p-6 sm:p-7 border border-stone-200 rounded-lg hover:border-bronze-300 transition-colors"
            >
