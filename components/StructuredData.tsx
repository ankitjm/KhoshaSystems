...
export const productsPageFAQs = [
  ...
  {
    question: 'What is RetailerOS?',
    answer: 'RetailerOS is a retail management platform built for mobile and electronics retailers — unifying IMEI tracking, brand scheme management, and GST billing in one system.',
  },
  {
    question: 'What is Real Desk?',
    answer: 'Real Desk is a connected sales suite for real estate developers and brokers — landing pages, lead capture, and bookings all writing to one CRM.',
  },
  {
    question: 'What is Passage?',
    answer: 'Passage is a case-management platform for Canada-focused immigration consultancies — track applicants, manage documents, and keep every case moving from one dashboard.',
  },
  {
    question: 'What does the AI Automation product do?',
    answer: 'Custom AI automation for business operations — workflow, support, and document processing, built around the systems you already use.',
  },
];
