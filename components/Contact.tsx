...
export const Contact: React.FC<ContactProps> = ({ showForm = false }) => {
  ...
  const contactMethods = (
    <div className="space-y-4 sm:space-y-5 mb-8 sm:mb-12">
      ...
      <a href="mailto:veda@khosha.tech" className="flex items-center gap-3 sm:gap-4 text-stone-300 group">
        <div className="p-2.5 sm:p-3 bg-stone-800 rounded-full group-hover:bg-bronze-600 group-hover:text-white transition-colors">
          <Mail size={18} />
        </div>
        <span className="text-sm sm:text-base hover:text-white transition-colors">veda@khosha.tech</span>
      </a>
      {pushStatus === 'IDLE' && (
        <button onClick={enablePush} className="flex items-center gap-3 sm:gap-4 text-stone-300 group text-left w-full">
          <div className="p-2.5 sm:p-3 bg-stone-800 rounded-full group-hover:bg-bronze-600 group-hover:text-white transition-colors">
            <Bell size={18} />
          </div>
          <span className="text-sm sm:text-base group-hover:text-white transition-colors">Enable Push Notifications</span>
        </button>
      )}
      {pushStatus === 'DENIED' && (
        <div className="flex items-center gap-3 sm:gap-4 text-stone-500">
          ...
          <span className="text-sm sm:text-base">Notifications blocked — enable in browser settings</span>
        </div>
      )}
    </div>
  );
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 mb-8">
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <a href="/products/canada-immigration" className="block text-stone-500 hover:text-stone-300 text-xs transition-colors">Passage</a>
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <a href="mailto:veda@khosha.tech" className="block text-stone-500 hover:text-stone-300 text-xs transition-colors">Email Us</a>
                </div>
              </div>
            </div>
