...
import { ArrowRight, Mail, MapPin, CheckCircle, AlertCircle, Bell } from 'lucide-react';
...
export const Contact: React.FC = () => {
  const [formData, setFormData] = useState({
    name: '', company: '', email: '', goal: 'Web Application'
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (dbResult.success) {
      setStatus('SUCCESS');
      setFormData({ name: '', company: '', email: '', goal: 'Web Application' });
    } else {
      setStatus('ERROR');
    }
  };
