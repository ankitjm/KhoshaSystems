...
const ROUTES = [
  ...
  '/getting-started',
  // New blog posts
  '/blog/how-to-choose-retail-management-software',
  '/blog/retaileros-vs-traditional-pos-modern-retailers',
  '/blog/best-pos-systems-small-retailers-2026',
...
const seoConfig = {
  ...
  '/work': {
    title: 'Our Work | Software Projects & Case Studies | Khosha Systems Bangalore',
  ...
  '/philosophy': {
    title: 'About Khosha Systems | Architect-Led Software Company | 15+ Years | Bangalore',
    ...
    keywords: 'about Khosha Systems, Khosha Systems Bangalore, Ankit Mehta founder, software company Kumara Park Bangalore, technology consulting India, architect-led software company, best software company Bangalore for startups, tech company Kumara Park, software company Bengaluru'
  },
  '/contact': {
    title: 'Contact Khosha Systems | Software Company in Kumara Park, Bangalore',
  ...
  '/vancouver': {
    title: 'Software Development Company Vancouver | AI & SaaS Development | Khosha Systems',
    description: 'Khosha Systems Vancouver — custom web apps, SaaS & AI transformation. 15+ years experience, senior team with local presence.',
  ...
  '/solutions/fashion-retail': {
    title: 'Fashion Retail POS & Inventory Software India | RetailerOS | Khosha Systems',
  ...
  '/solutions/grocery': {
    title: 'Grocery Store & Supermarket POS Software India | RetailerOS | Khosha Systems',
  ...
  '/solutions/electronics': {
    title: 'Electronics & Mobile Shop POS Software India | RetailerOS | Khosha Systems',
  ...
  '/compare/retaileros-vs-iqmetrix': {
    title: 'RetailerOS vs iQmetrix | India-First Telecom Retail Software Alternative | Khosha Systems',
  ...
  '/compare/real-estate-crm-vs-selldo': {
    title: 'Khosha Real Estate CRM vs Sell.Do | Simpler & More Affordable CRM | Khosha Systems',
  ...
  '/compare/vms-vs-envoy': {
    title: 'Khosha VMS vs Envoy | India Pricing & Compliance | Visitor Management | Khosha Systems',
  ...
  '/compare/retaileros-vs-shopify': {
    title: 'RetailerOS vs Shopify POS | Telecom Retail Software with IMEI Tracking | Khosha Systems',
  ...
  '/compare/retaileros-vs-lightspeed': {
    title: 'RetailerOS vs Lightspeed | No Lock-In Telecom Retail POS | Khosha Systems',
  ...
  '/compare/retaileros-vs-square': {
    title: 'RetailerOS vs Square for Retail | Beyond Basic POS for Telecom | Khosha Systems',
  ...
  '/blog': {
    title: 'Blog | Software Development, AI & Digital Transformation Insights | Khosha Systems',
    description: 'Insights on software development, AI, retail tech & digital transformation from Khosha Systems, Bangalore.',
  ...
  '/success-stories': {
    title: 'Customer Success Stories | Real Results with Khosha Systems Software',
  ...
  '/help': {
    title: 'Knowledge Base | RetailerOS Help & Documentation | Khosha Systems',
    description: 'Get help with RetailerOS, Real Estate CRM, and Visitor Management. Guides, FAQs, and documentation from Khosha Systems.',
  ...
  '/pricing': {
    title: 'RetailerOS Pricing — Telecom Retail Management Software | Khosha Systems',
    description: 'RetailerOS pricing starts at ₹2,999/store/month. IMEI tracking, GST billing, scheme management, and multi-store analytics. 14-day free trial, no credit card required.',
  ...
  '/use-cases': {
    title: 'RetailerOS Use Cases — Real Results from Indian Retailers | Khosha Systems',
  ...
  '/features': {
    title: 'RetailerOS Features — IMEI Tracking, GST Billing, Scheme Management | Khosha Systems',
  ...
  '/getting-started': {
    title: 'Getting Started with RetailerOS — Onboarding Guide | Khosha Systems',
  ...
  '/404': {
    title: 'Page Not Found | Khosha Systems',
